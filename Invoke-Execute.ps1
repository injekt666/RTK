...
Thanks: 
- Contributors of the LOLBAS project (https://lolbas-project.github.io/) 
- Mitre ATT&CK Framework (https://attack.mitre.org/)

As some of these techniques and references are derived from those sources.
